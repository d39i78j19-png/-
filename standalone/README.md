...
固定の一覧にすると毎年アプリを直すことになるため、**今日の日付から自動で算出**します。

| 表示 | 内容 |
|---|---|
| 1番目 | 選考終盤・既卒含む（主対象の1つ前） |
| **2番目** | **主対象（初期選択）** |
| 3・4番目 | その先の2年分 |

主対象が切り替わるのは **6月** です。新卒採用は卒業年 Y に対して「Y-2年の夏にインターンが
始まり、Y-1年3月に広報解禁、6月に選考解禁、10月に内定式」と動くため、次の学年の動きが
始まる Y-1年の夏を境にしています。

実際の推移（同じロジックを日付だけ変えて検証したもの）:

| 日付 | 初期選択 | 一覧 |
|---|---|---|
| 2026-08 | 28卒（大学3年・修士1年） | 27・28・29・30 |
| 2027-05 | 28卒（大学4年・修士2年） | 27・28・29・30 |
| 2027-07 | 29卒（大学3年・修士1年） | 28・29・30・31 |
| 2030-09 | 32卒（大学3年・修士1年） | 31・32・33・34 |

学年の表記と年齢（19〜22歳）も同じ計算から出しているので、年度が変わってもズレません。
